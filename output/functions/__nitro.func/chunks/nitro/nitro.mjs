...
const _assets = {
  ["server:tarot-images.json"]: {
    import: () => import('../raw/tarot-images.mjs').then(r => r.default || r),
    meta: {"type":"application/json","etag":"\"39b2-TToO5rsjQAY8tjw2uTEE4gXaF9U\"","mtime":"2025-10-05T13:50:59.391Z"}
  }
};
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e2ecb565-4ce0-44fb-8b93-d3cceadd9f26",
...
const _AWWlEr = defineCachedEventHandler(async (event) => {
...
const _CY9dRW = lazyEventHandler(() => {
...
const _lazy_ADF0cG = () => import('../routes/api/chat.post.mjs');
const _lazy_TvJVjg = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/chat', handler: _lazy_ADF0cG, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_TvJVjg, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _AWWlEr, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _CY9dRW, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TvJVjg, lazy: true, middleware: false, method: undefined }
];
...
export { getResponseStatus as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, defineRenderHandler as e, getQuery as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, listener as l, publicAssetsURL as p, readBody as r, useRuntimeConfig as u };
